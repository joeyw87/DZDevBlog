...
//에디터가 설치된 웹경로
var g_dzEditorBasePath = "/resources/dzeditor_v1.1.5.3/";
...
var dzeEnvConfig = {
	...
	fnBindExternalData: function(nEditNumber, objExternalData) {
		duzon_http.showLoading();
		
		setTimeout(function() {
			doBindExternalData(nEditNumber, objExternalData);
		}, 700);
	}
};
