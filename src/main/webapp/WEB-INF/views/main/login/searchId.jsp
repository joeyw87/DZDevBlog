...
<script type="text/javascript">
	puddready(function() {
		...
		$("#btn_SearchPasswd").click(function () { fncMoveSearchPasswd(); });
		
		fncControlInit();
	});
	
	// 비밀번호 찾기
	function fncMoveSearchPasswd() {
		...
		$.ajax({
			...
			success : function(res) {
				...
				if (res.returnValue == "ok") {
					alert('인증에 성공하였습니다.');
					location.href = "/user/login/showUserId.do?seq=" + res.userSeq;
				}
...
<div>
	<form id="login-form" method="post">
		...
		<input type="button" id="btn_SearchPasswd" value="비밀번호 찾기">
	</form>
</div>
